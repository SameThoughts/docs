...
1. **Configure memory.** Pass file paths to `memory=` and optional [skills](/oss/python/deepagents/skills) to `skills=`. A [backend](/oss/python/deepagents/backends) controls storage and access.
